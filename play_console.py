...
def direction_to_string(direction):
    ...
    Direction names refer to TILE movement (not blank movement).
    The tuple represents blank movement, which is opposite to tile movement.
    """
    if direction == (-1, 0):
        return "DOWN"  # Blank moves up, tile moves down
    elif direction == (1, 0):
        return "UP"    # Blank moves down, tile moves up
    elif direction == (0, -1):
        return "RIGHT" # Blank moves left, tile moves right
    elif direction == (0, 1):
        return "LEFT"  # Blank moves right, tile moves left
    else:
        return "UNKNOWN"
